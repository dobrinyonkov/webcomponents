import{x as d}from"./lit-element.57026f9a.js";import{l as i}from"./if-defined.08fba587.js";import{o as t}from"./unsafe-html.5df53a7b.js";import{D as m}from"./docs.4dc8a165.js";import"./index.d901690a.js";import"./_commonjsHelpers.b8add541.js";import"./chunk-PCJTTTQV.55990814.js";import"./iframe.6b86e3a9.js";import"../sb-preview/runtime.mjs";import"./client.6942378e.js";import"./index.4504b959.js";import"./index.5ca63ce8.js";import"./index.5f460d07.js";import"./index.d2348c08.js";import"./index.b38f6aa4.js";import"./chunk-R4NKYYJA.15989c7a.js";const p={columnLayout:{control:{type:!1}},endColumnVisible:{control:{type:!1}},layout:{control:"select",options:["EndColumnFullScreen","MidColumnFullScreen","OneColumn","ThreeColumnsEndExpanded","ThreeColumnsMidExpanded","ThreeColumnsMidExpandedEndHidden","ThreeColumnsStartExpandedEndHidden","TwoColumnsMidExpanded","TwoColumnsStartExpanded"]},midColumnVisible:{control:{type:!1}},startColumnVisible:{control:{type:!1}},visibleColumns:{control:{type:!1}},endColumn:{control:{type:"text"}},midColumn:{control:{type:"text"}},startColumn:{control:{type:"text"}},"layout-change":{description:"Fired when the layout changes via user interaction by clicking the arrows or by changing the component size due to resizing.",table:{category:"events"},UI5CustomData:{parameters:[{name:"layout",type:"sap.ui.webc.fiori.types.FCLLayout",description:"The current layout"},{name:"columnLayout",type:"array",description:"The effective column layout, f.e [67%, 33%, 0]"},{name:"startColumnVisible",type:"boolean",description:"Indicates if the start column is currently visible"},{name:"midColumnVisible",type:"boolean",description:"Indicates if the middle column is currently visible"},{name:"endColumnVisible",type:"boolean",description:"Indicates if the end column is currently visible"},{name:"arrowsUsed",type:"boolean",description:"Indicates if the layout is changed via the arrows"},{name:"resize",type:"boolean",description:"Indicates if the layout is changed via resizing"}]}}},f={package:"@ui5/webcomponents-fiori",since:"1.0.0-rc.8"};var l=Object.freeze,b=Object.defineProperty,x=(e,s)=>l(b(e,"raw",{value:l(s||e.slice())})),o;const r="ui5-flexible-column-layout",B={title:"Fiori/FlexibleColumnLayout",component:r,parameters:{docs:{page:m({...f,component:r})}},argTypes:p},g=e=>d(o||(o=x([` <style>
      .col {
        height: 100%;
      }
      .colHeader {
    ...
    <\/script>`])),i(e.layout),i(e.hideArrows),i(e.accessibilityTexts),i(e.accessibilityRoles),t(e.startColumn),t(e.midColumn),t(e.endColumn)),n=g.bind({});n.args={startColumn:`
      ...
      </div>`};n.parameters={docs:{story:{inline:!1,iframeHeight:600}}};var a,c,u;n.parameters={...n.parameters,docs:{...(a=n.parameters)==null?void 0:a.docs,source:{originalSource:`args => {
  return html\` <style>
      .col {
        height: 100%;
      }
    ...
    <\/script>\`;
}`,...(u=(c=n.parameters)==null?void 0:c.docs)==null?void 0:u.source}}};const P=["Basic"];export{n as Basic,P as __namedExportsOrder,B as default};
//# sourceMappingURL=FlexibleColumnLayout.stories.c5e1ac78.js.map
