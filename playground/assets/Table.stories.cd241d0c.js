import{x as b}from"./lit-element.57026f9a.js";import{D as _}from"./docs.4dc8a165.js";import{l as n}from"./if-defined.08fba587.js";import{o as d}from"./unsafe-html.5df53a7b.js";import{T as P,a as j}from"./TableGrowingMode.77e95459.js";import"./index.d901690a.js";import"./_commonjsHelpers.b8add541.js";import"./chunk-PCJTTTQV.55990814.js";import"./iframe.6b86e3a9.js";import"../sb-preview/runtime.mjs";import"./client.6942378e.js";import"./index.4504b959.js";import"./index.5ca63ce8.js";import"./index.5f460d07.js";import"./index.d2348c08.js";import"./index.b38f6aa4.js";import"./chunk-R4NKYYJA.15989c7a.js";const K={growing:{control:"select",options:["Button","None","Scroll"]},mode:{control:"select",options:["MultiSelect","None","SingleSelect"]},columns:{control:{type:"text"}},default:{control:{type:"text"}},"popin-change":{description:"Fired when <code>ui5-table-column</code> is shown as a pop-in instead of hiding it.",table:{category:"events"},UI5CustomData:{parameters:[{name:"poppedColumns",type:"Array",description:"popped-in columns."}]}},"row-click":{description:"Fired when a row in <code>Active</code> mode is clicked or <code>Enter</code> key is pressed.",table:{category:"events"},UI5CustomData:{parameters:[{name:"row",type:"HTMLElement",description:"the activated row."}]}},"selection-change":{description:"Fired when selection is changed by user interaction in <code>SingleSelect</code> and <code>MultiSelect</code> modes.",table:{category:"events"},UI5CustomData:{parameters:[{name:"selectedRows",type:"Array",description:"An array of the selected rows."},{name:"previouslySelectedRows",type:"Array",description:"An array of the previously selected rows."}]}}},V={package:"@ui5/webcomponents"};var p=Object.freeze,O=Object.defineProperty,E=(l,W)=>p(O(l,"raw",{value:p(W||l.slice())})),m,g;const f="ui5-table";let e=0;const ce={title:"Main/Table",component:f,subcomponents:{TableColumn:"ui5-table-column",TableRow:"ui5-table-row",TableGroupRow:"ui5-table-group-row",TableCell:"ui5-table-cell"},parameters:{docs:{page:_({...V,component:f})}},argTypes:K},i=l=>b`
<ui5-table
    id="table-${++e}"
...
<ui5-table-column slot="columns" class="table-header-text-alignment">
    <span style="line-height: 1.4rem">Price</span>
</ui5-table-column>`,noDataText:"No Data"};o.storyName="Table with No Data";const t=i.bind({});t.args={growing:P.Button,columns:`
<ui5-table-column slot="columns">
    <span style="line-height: 1.4rem">Product</span>
</ui5-table-column>
<ui5-table-column slot="columns" min-width="800">
...
<ui5-table-column slot="columns" class="table-header-text-alignment">
    <span style="line-height: 1.4rem">Price</span>
</ui5-table-column>`};t.decorators=[l=>b(m||(m=E([`
`,`
<script>
...
`])),l(),e,e,e,e,e,e,e,e,e,e,e,e,e,e,e,e,e,e,e,e,e,e,e,e,e,e,e,e,e,e)];t.storyName='Growing Table with "More" button';const a=i.bind({});a.args={growing:P.Scroll,columns:`
...
</ui5-table-column>`};a.decorators=[l=>b(g||(g=E([`
...
\``,...(H=(B=o.parameters)==null?void 0:B.docs)==null?void 0:H.source}}};var M,k,I;t.parameters={...t.parameters,docs:{...(M=t.parameters)==null?void 0:M.docs,source:{originalSource:`args => html\`
<ui5-table
    id="table-\${++index}"
    no-data-text="\${ifDefined(args.noDataText)}"
    growing-button-text="\${ifDefined(args.growingButtonText)}"
...
\``,...(I=(k=t.parameters)==null?void 0:k.docs)==null?void 0:I.source}}};var C,L,R;a.parameters={...a.parameters,docs:{...(C=a.parameters)==null?void 0:C.docs,source:{originalSource:`args => html\`
<ui5-table
    id="table-\${++index}"
    no-data-text="\${ifDefined(args.noDataText)}"
    growing-button-text="\${ifDefined(args.growingButtonText)}"
...
\``,...(A=(U=r.parameters)==null?void 0:U.docs)==null?void 0:A.source}}};const ue=["BasicTable","TableDisplayInline","TableStickyHeader","TableNoData","GrowingTableMoreButton","GrowingTableScroll","GroupingTableSelect"];export{c as BasicTable,r as GroupingTableSelect,t as GrowingTableMoreButton,a as GrowingTableScroll,u as TableDisplayInline,o as TableNoData,s as TableStickyHeader,ue as __namedExportsOrder,ce as default};
//# sourceMappingURL=Table.stories.cd241d0c.js.map
