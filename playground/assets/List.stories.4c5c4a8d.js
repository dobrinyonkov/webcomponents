import{x as p}from"./lit-element.57026f9a.js";import{l as i}from"./if-defined.08fba587.js";import{o as G}from"./unsafe-html.5df53a7b.js";import{L as u,a as U}from"./ListSeparators.d80d2a3e.js";import{D as W}from"./docs.32cf2efa.js";import"./index.d901690a.js";import"./_commonjsHelpers.b8add541.js";import"./chunk-PCJTTTQV.a21dd487.js";import"./iframe.549db545.js";import"../sb-preview/runtime.mjs";import"./client.6942378e.js";import"./index.847a85b0.js";import"./index.5ca63ce8.js";import"./index.5f460d07.js";import"./index.d2348c08.js";import"./index.b38f6aa4.js";import"./chunk-R4NKYYJA.15989c7a.js";const j={growing:{control:"select",options:["Button","None","Scroll"]},mode:{control:"select",options:["Delete","MultiSelect","None","SingleSelect","SingleSelectAuto","SingleSelectBegin","SingleSelectEnd"]},separators:{control:"select",options:["All","Inner","None"]},default:{control:{type:"text"}},header:{control:{type:"text"}},"item-click":{description:"Fired when an item is activated, unless the item's <code>type</code> property is set to <code>Inactive</code>.",table:{category:"events"},UI5CustomData:{parameters:[{name:"item",type:"HTMLElement",description:"The clicked item."}]}},"item-close":{description:"Fired when the <code>Close</code> button of any item is clicked <br><br> <b>Note:</b> This event is only applicable to list items that can be closed (such as notification list items), not to be confused with <code>item-delete</code>.",table:{category:"events"},UI5CustomData:{parameters:[{name:"item",type:"HTMLElement",description:"the item about to be closed."}]}},"item-delete":{description:"Fired when the Delete button of any item is pressed. <br><br> <b>Note:</b> A Delete button is displayed on each item, when the component <code>mode</code> property is set to <code>Delete</code>.",table:{category:"events"},UI5CustomData:{parameters:[{name:"item",type:"HTMLElement",description:"the deleted item."}]}},"item-toggle":{description:"Fired when the <code>Toggle</code> button of any item is clicked. <br><br> <b>Note:</b> This event is only applicable to list items that can be toggled (such as notification group list items).",table:{category:"events"},UI5CustomData:{parameters:[{name:"item",type:"HTMLElement",description:"the toggled item."}]}},"selection-change":{description:"Fired when selection is changed by user interaction in <code>SingleSelect</code>, <code>SingleSelectBegin</code>, <code>SingleSelectEnd</code> and <code>MultiSelect</code> modes.",table:{category:"events"},UI5CustomData:{parameters:[{name:"selectedItems",type:"Array",description:"An array of the selected items."},{name:"previouslySelectedItems",type:"Array",description:"An array of the previously selected items."}]}}},z={package:"@ui5/webcomponents"};var m=Object.freeze,J=Object.defineProperty,q=(e,F)=>m(J(e,"raw",{value:m(F||e.slice())})),g;const f="ui5-list",ue={title:"Main/List",component:f,subcomponents:{StandardListItem:"ui5-li",CustomListItem:"ui5-li-custom",GroupHeaderListItem:"ui5-li-groupheader"},parameters:{docs:{page:W({...z,component:f})}},argTypes:j},d=e=>p` <ui5-list
...
}`,...(T=(S=a.parameters)==null?void 0:S.docs)==null?void 0:T.source}}};var w,I,N;r.parameters={...r.parameters,docs:{...(w=r.parameters)==null?void 0:w.docs,source:{originalSource:`args => {
  return html\` <ui5-list
    mode="\${ifDefined(args.mode)}"
    ?busy="\${ifDefined(args.busy)}"
    ?indent="\${ifDefined(args.indent)}"
...
}`,...(N=(I=r.parameters)==null?void 0:I.docs)==null?void 0:N.source}}};var E,M,_;s.parameters={...s.parameters,docs:{...(E=s.parameters)==null?void 0:E.docs,source:{originalSource:`args => {
  return html\` <ui5-list
    mode="\${ifDefined(args.mode)}"
    ?busy="\${ifDefined(args.busy)}"
    ?indent="\${ifDefined(args.indent)}"
...
}`,...(_=(M=s.parameters)==null?void 0:M.docs)==null?void 0:_.source}}};var L,C,k;o.parameters={...o.parameters,docs:{...(L=o.parameters)==null?void 0:L.docs,source:{originalSource:`args => {
  return html\` <ui5-list
    mode="\${ifDefined(args.mode)}"
    ?busy="\${ifDefined(args.busy)}"
    ?indent="\${ifDefined(args.indent)}"
  ...
  >
    ...
    >
      ...
      <ui5-li icon="shipping-status">Pending</ui5-li>
      <ui5-li icon="shipping-status">Declined</ui5-li>
    </ui5-list>\``,...(P=(O=c.parameters)==null?void 0:O.docs)==null?void 0:P.source}}};const pe=["Basic","Growing","SingleSelection","MultiSelection","GroupHeaders","Delete","NoData","SeparationTypes"];export{t as Basic,o as Delete,s as GroupHeaders,n as Growing,r as MultiSelection,l as NoData,c as SeparationTypes,a as SingleSelection,pe as __namedExportsOrder,ue as default};
//# sourceMappingURL=List.stories.4c5c4a8d.js.map
