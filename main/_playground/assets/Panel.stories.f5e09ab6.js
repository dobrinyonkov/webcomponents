import{x as v}from"./lit-element.179636e6.js";import{l as i}from"./if-defined.9da98955.js";import{o}from"./unsafe-html.ff185b2f.js";import{D as H}from"./docs.900f4496.js";import{P as s}from"./PanelAccessibleRole.57662edc.js";import"./index.bdfa8201.js";import"./_commonjsHelpers.b8add541.js";import"./chunk-S4VUQJ4A.0ad8f14d.js";import"./iframe.d2d30c97.js";import"../sb-preview/runtime.js";import"./client.69b06123.js";import"./index.4281e927.js";import"./index.5ca63ce8.js";import"./index.5f460d07.js";import"./index.d612502e.js";import"./index.b38f6aa4.js";const L={accessibleRole:{control:"select",options:["Complementary","Form","Region"]},headerLevel:{control:"select",options:["H1","H2","H3","H4","H5","H6"]}},T={package:"@ui5/webcomponents"},d="ui5-panel",W={title:"Main/Panel",component:d,parameters:{docs:{page:H({...T,component:d})}},argTypes:L},t=e=>v`
<ui5-panel
...
>
    ${o(e.header)}
    ${o(e.default)}
</ui5-panel>`,r=t.bind({});r.args={default:`
    ...
    </p>`,headerText:"Both expandable and expanded"};const l=t.bind({});l.args={default:`
    ...
    </ui5-list>`,headerText:"Select your country",accessibleRole:s.Complementary};const n=t.bind({});n.args={default:`
    <ui5-list mode="SingleSelectBegin">
        <ui5-li key="country1">Argentina</ui5-li>
        <ui5-li key="country2">Bulgaria</ui5-li>
        <ui5-li key="country3">China</ui5-li>
        <ui5-li key="country4">Germany</ui5-li>
    </ui5-list>`,headerText:"Country Of Birth",accessibleRole:s.Complementary,fixed:!0};n.storyName="Fixed Panel (Can't be Collapsed/Expanded)";const a=t.bind({});a.decorators=[e=>v`
<style>
    .header {
        display: flex;
        align-items: center;
...
</ui5-panel>\``,...(m=(u=r.parameters)==null?void 0:u.docs)==null?void 0:m.source}}};var f,p,g;l.parameters={...l.parameters,docs:{...(f=l.parameters)==null?void 0:f.docs,source:{originalSource:`args => html\`
<ui5-panel
    accessible-role="\${ifDefined(args.accessibleRole)}"
    header-text="\${ifDefined(args.headerText)}"
    ?fixed="\${ifDefined(args.fixed)}"
...
>
    \${unsafeHTML(args.header)}
    \${unsafeHTML(args.default)}
</ui5-panel>\``,...(g=(p=l.parameters)==null?void 0:p.docs)==null?void 0:g.source}}};var h,y,b;n.parameters={...n.parameters,docs:{...(h=n.parameters)==null?void 0:h.docs,source:{originalSource:`args => html\`
<ui5-panel
    accessible-role="\${ifDefined(args.accessibleRole)}"
    header-text="\${ifDefined(args.headerText)}"
    ?fixed="\${ifDefined(args.fixed)}"
...
>
    \${unsafeHTML(args.header)}
    \${unsafeHTML(args.default)}
</ui5-panel>\``,...(D=(x=a.parameters)==null?void 0:x.docs)==null?void 0:D.source}}};const j=["BasicPanel","PanelWithList","FixedPanel","PanelCustomHeader"];export{r as BasicPanel,n as FixedPanel,a as PanelCustomHeader,l as PanelWithList,j as __namedExportsOrder,W as default};
//# sourceMappingURL=Panel.stories.f5e09ab6.js.map
