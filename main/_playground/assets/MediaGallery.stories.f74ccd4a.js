import{x as o}from"./lit-element.179636e6.js";import{o as O}from"./unsafe-html.ff185b2f.js";import{l}from"./if-defined.9da98955.js";import{D as P}from"./docs.400266cf.js";import{M as C,a as k}from"./MediaGalleryMenuHorizontalAlign.a8540e0f.js";import"./index.bdfa8201.js";import"./_commonjsHelpers.b8add541.js";import"./chunk-S4VUQJ4A.defbc0ae.js";import"./iframe.7336b0e7.js";import"../sb-preview/runtime.js";import"./client.69b06123.js";import"./index.a0b4809e.js";import"./index.5ca63ce8.js";import"./index.5f460d07.js";import"./index.d612502e.js";import"./index.b38f6aa4.js";const R={layout:{control:"select",options:["Auto","Horizontal","Vertical"]},menuHorizontalAlign:{control:"select",options:["Left","Right"]},menuVerticalAlign:{control:"select",options:["Bottom","Top"]}},U={package:"@ui5/webcomponents-fiori",since:"1.1.0"};var d=Object.freeze,F=Object.defineProperty,N=(e,E)=>d(F(e,"raw",{value:d(E||e.slice())})),c;const y="ui5-media-gallery",Q=e=>o`
    <style>
    ...
    ${e()}
`,de={title:"Fiori/MediaGallery",component:y,subcomponents:{MediaGalleryItem:"ui5-media-gallery-item"},parameters:{docs:{page:P({...U,component:y})}},decorators:[Q],argTypes:R};let Y=0;const i=e=>o` <ui5-media-gallery
        id="media-gallery-${Y++}"
    ...
    >
        ${O(e.default)}
    </ui5-media-gallery>`,s=i.bind({});s.args={showAllThumbnails:!0,default:`
    ...
    <ui5-media-gallery-item>
        <img src="../assets/images/HT-2026.jpg" />
    </ui5-media-gallery-item>`};const t=i.bind({});t.args={showAllThumbnails:!0,layout:C.Horizontal,menuHorizontalAlign:k.Right,default:`
    <ui5-media-gallery-item>
        <img src="../assets/images/HT-1000.jpg" />
    </ui5-media-gallery-item>
    <ui5-media-gallery-item>
...
<\/script>`])),e())];a.args={interactiveDisplayArea:!0,default:`
    ...
    <ui5-media-gallery-item>
        <img src="../assets/images/HT-2026.jpg" />
    </ui5-media-gallery-item>`};a.parameters={docs:{story:{inline:!1,iframeHeight:"800px"}}};var p,f,h;s.parameters={...s.parameters,docs:{...(p=s.parameters)==null?void 0:p.docs,source:{originalSource:`args => {
...
}`,...(h=(f=s.parameters)==null?void 0:f.docs)==null?void 0:h.source}}};var v,D,T;r.parameters={...r.parameters,docs:{...(v=r.parameters)==null?void 0:v.docs,source:{originalSource:`args => {
  return html\` <ui5-media-gallery
        id="media-gallery-\${index++}"
        ?show-all-thumbnails="\${ifDefined(args.showAllThumbnails)}"
        ?interactive-display-area="\${ifDefined(args.interactiveDisplayArea)}"
...
}`,...(T=(D=r.parameters)==null?void 0:D.docs)==null?void 0:T.source}}};var b,$,H;t.parameters={...t.parameters,docs:{...(b=t.parameters)==null?void 0:b.docs,source:{originalSource:`args => {
  return html\` <ui5-media-gallery
        id="media-gallery-\${index++}"
        ?show-all-thumbnails="\${ifDefined(args.showAllThumbnails)}"
        ?interactive-display-area="\${ifDefined(args.interactiveDisplayArea)}"
...
}`,...(H=($=t.parameters)==null?void 0:$.docs)==null?void 0:H.source}}};var A,j,w;n.parameters={...n.parameters,docs:{...(A=n.parameters)==null?void 0:A.docs,source:{originalSource:`args => {
  return html\` <ui5-media-gallery
        id="media-gallery-\${index++}"
        ?show-all-thumbnails="\${ifDefined(args.showAllThumbnails)}"
        ?interactive-display-area="\${ifDefined(args.interactiveDisplayArea)}"
...
}`,...(V=(x=m.parameters)==null?void 0:x.docs)==null?void 0:V.source}}};var G,M,L;g.parameters={...g.parameters,docs:{...(G=g.parameters)==null?void 0:G.docs,source:{originalSource:`args => {
  return html\` <ui5-media-gallery
        id="media-gallery-\${index++}"
        ?show-all-thumbnails="\${ifDefined(args.showAllThumbnails)}"
        ?interactive-display-area="\${ifDefined(args.interactiveDisplayArea)}"
...
}`,...(L=(M=g.parameters)==null?void 0:M.docs)==null?void 0:L.source}}};var S,W,q;u.parameters={...u.parameters,docs:{...(S=u.parameters)==null?void 0:S.docs,source:{originalSource:`args => {
  return html\` <ui5-media-gallery
        id="media-gallery-\${index++}"
        ?show-all-thumbnails="\${ifDefined(args.showAllThumbnails)}"
        ?interactive-display-area="\${ifDefined(args.interactiveDisplayArea)}"
...
}`,...(q=(W=u.parameters)==null?void 0:W.docs)==null?void 0:q.source}}};var I,B,_;a.parameters={...a.parameters,docs:{...(I=a.parameters)==null?void 0:I.docs,source:{originalSource:`args => {
  return html\` <ui5-media-gallery
        id="media-gallery-\${index++}"
        ?show-all-thumbnails="\${ifDefined(args.showAllThumbnails)}"
        ?interactive-display-area="\${ifDefined(args.interactiveDisplayArea)}"
...
}`,...(_=(B=a.parameters)==null?void 0:B.docs)==null?void 0:_.source}}};const ce=["Basic","WithVerticalLayout","WithThumbnailsOnTheRight","WithSeparateImageThumbnail","WithVideoContent","WithDisabledContent","WithInitiallySelected","WithThumbnailOverflow"];export{s as Basic,g as WithDisabledContent,u as WithInitiallySelected,n as WithSeparateImageThumbnail,a as WithThumbnailOverflow,t as WithThumbnailsOnTheRight,r as WithVerticalLayout,m as WithVideoContent,ce as __namedExportsOrder,de as default};
//# sourceMappingURL=MediaGallery.stories.f74ccd4a.js.map
