import{x as f}from"./lit-element.179636e6.js";import{l as i}from"./if-defined.9da98955.js";import{o as F}from"./unsafe-html.ff185b2f.js";import{L as u,a as W}from"./ListSeparators.d80d2a3e.js";import{D as j}from"./docs.900f4496.js";import"./index.bdfa8201.js";import"./_commonjsHelpers.b8add541.js";import"./chunk-S4VUQJ4A.0ad8f14d.js";import"./iframe.d2d30c97.js";import"../sb-preview/runtime.js";import"./client.69b06123.js";import"./index.4281e927.js";import"./index.5ca63ce8.js";import"./index.5f460d07.js";import"./index.d612502e.js";import"./index.b38f6aa4.js";const z={growing:{control:"select",options:["Button","None","Scroll"]},mode:{control:"select",options:["Delete","MultiSelect","None","SingleSelect","SingleSelectAuto","SingleSelectBegin","SingleSelectEnd"]},separators:{control:"select",options:["All","Inner","None"]}},J={package:"@ui5/webcomponents"};var g=Object.freeze,q=Object.defineProperty,K=(e,G)=>g(q(e,"raw",{value:g(G||e.slice())})),p;const m="ui5-list",ce={title:"Main/List",component:m,subcomponents:{StandardListItem:"ui5-li",CustomListItem:"ui5-li-custom",GroupHeaderListItem:"ui5-li-groupheader"},parameters:{docs:{page:j({...J,component:m})}},argTypes:z},d=e=>f` <ui5-list
    mode="${i(e.mode)}"
    ?busy="${i(e.busy)}"
    ?indent="${i(e.indent)}"
    ?growing="${i(e.growing)}"
  ...
  >
    ...
    >
      ...
      <ui5-li icon="shipping-status">Pending</ui5-li>
      <ui5-li icon="shipping-status">Declined</ui5-li>
    </ui5-list>\``,...(A=(C=c.parameters)==null?void 0:C.docs)==null?void 0:A.source}}};const ue=["Basic","Growing","SingleSelection","MultiSelection","GroupHeaders","Delete","NoData","SeparationTypes"];export{n as Basic,o as Delete,s as GroupHeaders,t as Growing,r as MultiSelection,l as NoData,c as SeparationTypes,a as SingleSelection,ue as __namedExportsOrder,ce as default};
//# sourceMappingURL=List.stories.45922a76.js.map
