...
<Preview>
  <Story
    ...
    args={{
      ...
      defaultSlot: html` <ui5-li selected="" icon="map" icon-end=""
          >Argentina</ui5-li
        >
        <ui5-li icon="map" icon-end="">Bulgaria</ui5-li>
        <ui5-li icon="map" icon-end="">China</ui5-li>
        <ui5-li type="Inactive" icon="map" icon-end=""
          >Denmark (ui5-li type='Inactive')</ui5-li
        >`,
    }}
  >
    {Template.bind({})}
...
<Preview>
  <Story
    ...
    args={{
      ...
      defaultSlot: html` <ui5-li>Pineapple</ui5-li>
...
<Preview>
  <Story
    ...
    args={{
      mode: "MultiSelect",
      defaultSlot: html` <ui5-li-groupheader
