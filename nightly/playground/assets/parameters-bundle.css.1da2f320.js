const _={packageName:"@ui5/webcomponents-fiori",fileName:"themes/sap_horizon/parameters-bundle.css",content:`[data-ui5-compact-size] [_ui5host],
...
:root [_ui5host] {\r
	--_ui5_shellbar_root_height: 3.25rem;\r
	--_ui5_shellbar_logo_outline_color: var(--sapContent_FocusColor);\r
	--_ui5_shellbar_logo_outline: var(--sapContent_FocusWidth) var(--sapContent_FocusStyle) var(--_ui5_shellbar_logo_outline_color);\r
	--_ui5_shellbar_logo_outline_offset: -0.125rem;\r
	--_ui5_shellbar_outline_offset: -0.1875rem;\r
\r
	--_ui5_shellbar_button_border: none;\r
	--_ui5_shellbar_button_border_radius: var(--sapButton_BorderCornerRadius);\r
	--_ui5_shellbar_button_badge_border: 1px solid var(--sapContent_BadgeBackground);\r
	--_ui5_shellbar_logo_border_radius: 0.5rem;\r
	--_ui5_shellbar_button_box_shadow: var(--sapContent_Interaction_Shadow);\r
	--_ui5_shellbar_button_active_color: var(--sapShell_Active_TextColor);\r
	--_ui5_shellbar_logo_outline_border_radius: var(--sapField_BorderCornerRadius);\r
	--_ui5_shellbar_copilot_stop_color1: #0070F2;\r
	--_ui5_shellbar_copilot_stop_color2: #EBF8FF;\r
	--_ui5_shellbar_copilot_focus_offset: 3px;\r
	--_ui5_shellbar_search_button_border_radius: 50%;\r
	--_ui5_shellbar_search_button_size: 1.75rem;\r
	--_ui5_shellbar_search_field_height: 2.25rem;\r
	--_ui5_shellbar_search_field_background: var(--sapShell_InteractiveBackground);\r
	--_ui5_shellbar_search_field_border: none;\r
	--_ui5_shellbar_search_field_color: var(--sapShell_InteractiveTextColor);\r
	--_ui5_shellbar_search_field_background_hover: var(--sapShell_Hover_Background);\r
	--_ui5_shellbar_search_field_box_shadow_hover: var(--sapContent_Interaction_Shadow);\r
	--_ui5_shellbar_overflow_container_middle_height: 3rem;\r
	--_ui5_shellbar_menu_button_title_font_size: var(--sapFontHeader5Size);\r
}
:root [_ui5host] {\r
	--_ui5_shellbar_input_border_radius: 1.125rem;\r
	--_ui5_shellbar_input_focus_border_radius: 1.125rem;\r
	--_ui5_shellbar_input_background_color: var(--sapShell_InteractiveBackground);\r
}
:root [_ui5host] {
...
:root [_ui5host] {
	--_ui5_side_navigation_separator_backgound: var(--sapAccentColor6);
	--_ui5_side_navigation_icon_color: var(--sapHighlightColor);
	--_ui5_side_navigation_icon_size: 1.125rem;
	--_ui5_side_navigation_toggle_icon_size: 0.875rem;
	--_ui5_side_navigation_collapsed_state_width: 3.5rem;
	--_ui5_side_navigation_indent_step: 2.3125rem;
	--_ui5_side_navigation_icon_padding: 1.1875rem;
}
:root [_ui5host] {
...
}`},t={_};export{_,t as default};
//# sourceMappingURL=parameters-bundle.css.1da2f320.js.map
